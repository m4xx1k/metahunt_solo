...
--
-- Run:  analytics/lab.sh -tAf analytics/experiments/004-graph-v0/export.sql \
--         > apps/web/lib/metalab/graph-v0.json
...
SELECT jsonb_build_object(
  ...
  'provenance', jsonb_build_object(
    ...
    'generatedAt',   now(),
    'experiment',    'analytics/experiments/004-graph-v0/export.sql',
    'issue',         'MET-129'
  ),
