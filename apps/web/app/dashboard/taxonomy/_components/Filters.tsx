  ...
  return (
    <div className="flex flex-col gap-3 border border-border bg-bg-card p-3">
      <div className="flex flex-wrap items-center gap-2">
        <span className="font-mono text-2xs uppercase tracking-wider text-text-muted">status</span>
        {STATUSES.map((s) => {
      ...
      <div className="flex flex-wrap items-center gap-2">
        <span className="font-mono text-2xs uppercase tracking-wider text-text-muted">type</span>
        <button
          type="button"
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
        ...
        <label className="flex items-center gap-2 font-mono text-xs text-text-muted">
          ...
          <input
            ...
            placeholder="0"
            aria-label="min blocked vacancies"
        ...
        <span className="font-mono text-2xs text-text-muted sm:ml-auto">found · {total}</span>
      </div>
    </div>
  );
}
