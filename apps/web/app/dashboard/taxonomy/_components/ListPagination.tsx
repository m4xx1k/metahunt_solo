    ...
    <div className="flex items-center justify-between gap-3">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          disabled={!hasPrev}
          onClick={handlePrev}
          className={cn(linkBase, hasPrev ? "hover:bg-bg-elev hover:text-accent" : "opacity-40")}
        >
          ← prev
        </button>
        <button
          ...
          disabled={!hasNext}
          onClick={handleNext}
          className={cn(linkBase, hasNext ? "hover:bg-bg-elev hover:text-accent" : "opacity-40")}
        >
          next →
        </button>
      </div>
