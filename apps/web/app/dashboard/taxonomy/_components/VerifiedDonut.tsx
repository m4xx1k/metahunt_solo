...
export function VerifiedDonut({ fullyVerified, total }: { fullyVerified: number; total: number }) {
  return (
    <div className="flex items-center gap-5 border border-border bg-bg-elev p-5">
      <Donut
        ...
        size={104}
        thickness={14}
        ariaLabel="vacancies with a fully verified taxonomy"
      />
      <div className="flex flex-col gap-1">
        ...
        <span className="font-mono text-xs text-text-secondary">
          role, skills and domain all verified
        </span>
      </div>
    </div>
  );
