...
import { LatestPerSource } from "@/components/monitoring/LatestPerSource";
import { IngestsTable } from "@/components/monitoring/IngestsTable";
import { RssRecordCard } from "@/components/monitoring/RssRecordCard";
import { RecordsFilters } from "@/components/monitoring/RecordsFilters";
...
export default async function MonitoringPage({
  ...
  return (
    <main className="flex min-h-screen flex-col bg-bg">
      <MonitoringHeader title="ETL monitoring" />
