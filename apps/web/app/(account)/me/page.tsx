...
export default function MePage() {
  ...
  if (isLoading) {
    return <p className="font-mono text-2xs uppercase tracking-wider text-text-muted">loading…</p>;
  }

  if (!isLoggedIn) {
    return (
      <div className="mx-auto max-w-sm border border-border bg-bg-card p-6 shadow-brut">
        <h1 className="mb-2 font-display text-lg text-text-primary">log in to see your saved</h1>
