...
export default class TypeBuilder {
  ...
  ExtractedVacancyRequirementsV2: ClassViewer<
  ...
  SkillRequirement: ClassViewer<"SkillRequirement", "anyOf">;
  ...
  EmploymentType: EnumViewer<
    "EmploymentType",
    "FULL_TIME" | "PART_TIME" | "CONTRACT" | "FREELANCE" | "INTERNSHIP"
  >;

  EngagementType: EnumViewer<
    "EngagementType",
    "PRODUCT" | "OUTSOURCE" | "OUTSTAFF" | "STARTUP" | "AGENCY"
  >;

  EnglishLevel: EnumViewer<
    "EnglishLevel",
  ...
  constructor() {
    ...
    this.CandidateSkills = this.tb.classViewer("CandidateSkills", ["required", "optional"]);
    ...
    this.ExtractedLocation = this.tb.classViewer("ExtractedLocation", ["city", "country"]);
    ...
    this.SkillRequirement = this.tb.classViewer("SkillRequirement", ["anyOf"]);
    ...
    this.Currency = this.tb.enumViewer("Currency", ["USD", "EUR", "UAH"]);
    ...
    this.RequirementPriority = this.tb.enumViewer("RequirementPriority", ["MUST", "NICE"]);
    ...
    this.WorkFormat = this.tb.enumViewer("WorkFormat", ["REMOTE", "OFFICE", "HYBRID"]);
  }
